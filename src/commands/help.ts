...
const NOTES: Record<string, string> = {
  ...
  challenge:
    "Fights their **saved** line-up, online or not — so scout with `/team view` first. 10 per hour. Add `wager_shards`, or `stake_card` + `their_card`, to play for something; wagered fights have to be accepted first.",
  commands: "This list.",
};
