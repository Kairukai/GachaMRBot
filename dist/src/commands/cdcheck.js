...
const stamp = (d) => `<t:${Math.floor(d.getTime() / 1000)}:R>`;
export async function execute(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        name: "Rolls",
        value: `**${rollsLeft}** / ${settings.rollsPerHour} left` +
        ...
        name: "Claims",
        value: `**${claimsLeft}** / ${settings.claimsPerHour} left` +
...
//# sourceMappingURL=cdcheck.js.map